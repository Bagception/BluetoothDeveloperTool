...
import de.philipphock.bluetooth.core.mvc.BTServerStateListener;
...
public class BTServer  implements Runnable {
	...
	public void run() {
		StreamConnectionNotifier service;
			...
			try {
				service = (StreamConnectionNotifier) Connector.open( "btspp://localhost:" + btservice.getServiceUUID() + ";name="+btservice.getServiceName() );
